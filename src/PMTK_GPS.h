...
#define PMTK_RESPONSE_TIMEOUT -1
#define PMTK_RESPONSE_INVALID 0
#define PMTK_RESPONSE_UNSUPPORTED 1
#define PMTK_RESPONSE_FAIL 2
#define PMTK_RESPONSE_SUCCESS 3
...
class PMTK_GPS : public TinyGPSPlus {
	...
	private:
		...
		bool send(const unsigned int type, bool checkAck=true);
		bool send(const unsigned int type, const char* data, bool checkAck=true);
